...
public class Garage extends Room implements Interactable, Exit {
    ...
    public String getDescription() {
        return "You are in a large GARAGE with the only visible light coming from the open kitchen door.\n" +
    ...
    public String interact(Player player) {
        ...
        return "You try to open the garage door manually by pulling it up and you immediately see a wave of light coming through.\n" +
                "Then, as soon as you let go; the door falls straight down nearly missing your feet.";
    }
